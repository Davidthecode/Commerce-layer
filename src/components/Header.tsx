    ...
    return (
        <header className='mt-16 mx-8 alg:mx-16 alg:mt-20 xl:px-8'>
            <div className="text-left lg:w-4/5">
                ...
                <p className="mt-4 alg:mt-8 alg:text-lg">ShopConnect is an API-first commerce engine that makes it easy to go headless. Start fast with our production-ready micro frontends. Scale globally with our full suite of APIs, webhooks, and dev tools.</p>
            </div>
