    ...
    <nav className="mx-5 alg:mx-12 mt-4 xl:px-8">
      <section className="flex items-center">
        <figure className="flex items-center">
          <img src={logo} alt="" className="w-16 alg:w-20 h-20" />
        ...
        <aside className='hidden xl:flex xl:ml-auto cursor-pointer'>
          ...
          <div className='ml-10'>
            <button className='border px-3 py-2 mx-4 rounded-lg font-medium text-[#666EFF] bg-blue-100 hover:bg-blue-50'>Sign in</button>
