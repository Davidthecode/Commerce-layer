  ...
  return (
    <div>
      <div className="bg-black xl:px-8">
        <h1 className="bg-black text-white text-4xl font-medium px-8 py-20 mt-12 alg:px-16 alg:text-7xl alg:py-24 leading-loose">Commerce Layer is the commerce API for everything brands</h1>
      </div>
